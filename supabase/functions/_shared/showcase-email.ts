...
export function showcaseConfirmationHtml(o: ShowcaseEmailOptions): string {
    ...
    const t = en ? {
        ...
        programWhat: 'The electronic <strong>Neotone</strong> handpan, <strong>Yishama</strong> acoustic handpans, the <strong>handpan microphones</strong>, the <strong>Gonilélé</strong> African harp, the <strong>calabash</strong> — and the <strong>Handpan Companion</strong> app, which makes music visible. Whichever of them brought you here, it will be out on the floor.',
        program: [
            ...
            ['Handpan Companion, the app that makes music visible', 'Live demonstration: the colours, the chord constellations, and how you learn by seeing music rather than deciphering sheet music.'],
...
export function showcaseDatesHtml(o: ShowcaseDatesOptions): string {
    ...
    const t = en ? {
        ...
        what: 'The electronic <strong>Neotone</strong> handpan, <strong>Yishama</strong> acoustic handpans, the <strong>handpan microphones</strong>, the <strong>Gonilélé</strong> African harp, the <strong>calabash</strong> — and the <strong>Handpan Companion</strong> app, which makes music visible. You play, you listen, you ask anything.',
