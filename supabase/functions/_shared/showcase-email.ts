...
export function showcaseConfirmationHtml(o: ShowcaseEmailOptions): string {
    ...
    const t = en ? {
        ...
        program: [
            ...
            ['Handpan Constellation Studio, the app that makes music visible', 'Live demonstration: the colours, the chord constellations, and how you learn by seeing music rather than deciphering sheet music.'],
        ...
        program: [
            ...
            ['Handpan Constellation Studio, l’app qui rend la musique visible', 'Démonstration en direct : les couleurs, les constellations d’accords, et comment on apprend en voyant la musique plutôt qu’en déchiffrant des partitions.'],
