...
//
// Traduction espagnole produite depuis le FRANÇAIS de `src/data/guides.ts` par
...
export const esGuides: GuidesByLang = {
  "learn": {
    ...
    "sections": [
      ...
      },
      {
        "id": "solfege",
        "icon": "lucide:eye-off",
        "heading": "¿Necesitas saber teoría musical? (no)",
        "blocks": [
          {
            "kind": "p",
            "html": "No. El handpan es ideal para aprender de oído. Las notas ya están afinadas: es prácticamente imposible tocarlo mal. Yo mismo tomé 7,5 horas semanales de clases de teoría musical, en 4 niveles diferentes, para ponerme al día: aún no sé leer partituras, y lo aprendí todo de oído. La teoría musical podría interesarte más adelante, por curiosidad, pero nunca es un requisito para empezar."
          }
        ]
      },
      {
        "id": "methode",
        "icon": "lucide:palette",
        "heading": "Aprender a través de los colores y las formas.",
        "blocks": [
          {
            "kind": "p",
      ...
      },
      {
        ...
        "heading": "¿Por dónde empezar, concretamente?",
        "blocks": [
          {
            "kind": "ul",
            "items": [
              "Acomódese cómodamente, con el instrumento apoyado en su regazo o en un soporte, ligeramente inclinado hacia usted.",
              "Toca el timbre central con las yemas de los dedos, de forma relajada: escucha cómo resuena la nota antes de continuar.",
              "Repase las notas una por una para familiarizarse con su ubicación y color.",
              "Reproduce una melodía corta de 3 o 4 notas, en bucle, hasta que te salga por sí sola.",
              "Añade un acorde (una forma) y luego únelo a la melodía: ya estás improvisando."
            ]
          },
          {
            "kind": "p",
            "html": "Diez minutos al día es mejor que una hora una vez a la semana. La regularidad, no la duración, es lo que lleva al progreso en la interpretación del handpan."
          }
        ]
      },
      {
        ...
        "heading": "¿Acústico o electrónico para empezar?",
        "blocks": [
          {
            "kind": "p",
      ...
      },
      {
        ...
        "heading": "¿Qué herramienta usar para aprender? Handpan Constellation Studio",
        "blocks": [
          {
            "kind": "p",
      ...
      },
      {
        ...
        "heading": "Llevarlo al siguiente nivel: cursos",
        "blocks": [
          {
            "kind": "p",
    ...
    "relatedHeading": "Para ir más allá",
    "related": [
      {
        "href": "/handpan-app",
        "label": "Descubre la aplicación Handpan Constellation Studio"
      },
      {
        "href": "/cours",
        "label": "Toma clases de handpan"
      },
      {
        "href": "/le-neotone",
        "label": "El handpan electrónico Neotone"
      },
      {
        "href": "/blog/handpan-par-les-couleurs",
        "label": "Artículo: El handpan en colores"
      },
      {
    ...
    "faq": [
      {
        "q": "¿Es difícil aprender a tocar el handpan?",
        "a": "No, es uno de los instrumentos más accesibles que existen. Las notas están afinadas juntas, así que todo lo que toques suena bien. En solo unos minutos puedes tocar una melodía sencilla; el progreso llega con la práctica."
      },
      {
        "q": "¿Cuánto tiempo se tarda en aprender a tocar el handpan?",
        "a": "Desde la primera sesión, tocarás melodías sencillas. Con solo unas semanas de práctica regular (10 minutos al día), improvisarás con placer. Perfeccionar el ritmo y los matices lleva meses, como con cualquier instrumento."
      },
      {
      ...
      },
      {
        ...
        "a": "No necesariamente al principio: la versión gratuita Discovery de Handpan Constellation Studio te permite practicar en modo acústico. Para tocar de verdad con las manos, un handpan acústico o un Neotone electrónico se vuelve indispensable rápidamente."
      }
    ],
    "cta": {
      "heading": "¿Listo para tocar tus primeras melodías?",
      "text": "Prueba el método de color directamente en la aplicación; la versión Discovery es gratuita.",
      "primary": {
        "href": "/handpan-app#acces",
        "label": "Acceso a la aplicación"
      },
      "secondary": {
        "href": "/cours",
        "label": "Ver cursos"
  ...
  "vsAcoustic": {
    ...
    "sections": [
      {
        "id": "differences",
        "icon": "lucide:git-compare",
        "heading": "Las diferencias reales",
        "blocks": [
          {
            "kind": "p",
            "html": "La diferencia no reside en el gesto —en ambos casos se toca con las manos— sino en la forma en que se produce el sonido y en lo que el instrumento permite hacer a su alrededor."
          },
          {
            "kind": "ul",
            "items": [
      ...
      },
      {
        "id": "pour-qui",
        "icon": "lucide:users",
        "heading": "¿A quién va dirigido cada instrumento?",
        "blocks": [
          {
            "kind": "p",
        ...
        "blocks": [
          {
            ...
            "rows": [
              [
                "Su",
                "Resonancia natural y orgánica",
                "Amplificado, tono perfecto"
              ],
              [
                "Jugar con auriculares / por la noche",
                "No",
                "Sí"
              ],
              [
              ...
              [
                "Efectos (reverberación, retardo…)",
                "No",
                "Sí"
              ],
              [
                "MIDI / grabación",
                "Se requiere microondas",
                "Integrado"
              ],
              [
                "Desafinado / oxidado",
              ...
              [
                "Jugando en círculo, al aire libre",
                "Ideal",
                "Requiere amplificador/auriculares."
              ]
            ]
          }
        ]
      },
      {
        "id": "conclusion",
        "icon": "lucide:scale",
        "heading": "Una conclusión matizada",
        "blocks": [
          {
            "kind": "p",
    ...
    "related": [
      {
        "href": "/le-neotone",
        "label": "Descubre el handpan electrónico Neotone"
      },
      {
        "href": "/handpan-app",
        "label": "Aplicación Handpan Constellation Studio (acústica + electrónica)"
      },
      {
        "href": "/blog/pourquoi-handpan-electronique",
        "label": "Artículo: ¿Por qué el handpan electrónico?"
      }
    ],
    "faqHeading": "Preguntas frecuentes",
    "faq": [
      {
        "q": "¿El handpan electrónico suena como un handpan real?",
        "a": "El Neotone reproduce fielmente el timbre del handpan, con una entonación perfecta y efectos añadidos. El tacto es idéntico. Lo que cambia es la resonancia en el aire de un instrumento acústico, que aquí se sustituye por la escucha a través de auriculares, altavoces o un amplificador."
      },
      {
        "q": "¿Se puede tocar el handpan electrónico con auriculares?",
        "a": "Sí, esa es una de sus mayores ventajas. El Neotone se toca completamente con auriculares, sin molestar a nadie, lo que resulta ideal para tocar en un apartamento por la noche o para grabaciones nítidas. Pero no es solo un instrumento para tocar con auriculares: también se puede tocar al aire libre con un amplificador como el Bose S1."
      },
      {
  ...
  "chooseHandpan": {
    ...
    "sections": [
      {
        "id": "nombre-notes",
        "icon": "lucide:hash",
        "heading": "¿Cuántas notas?",
        "blocks": [
          {
            "kind": "p",
            "html": "Un handpan acústico consta de un ding y notas dispuestas a su alrededor: los modelos comunes tienen de 8 a 10 notas, y algunos añaden notas debajo de la caja (\"notas graves\"). En el ámbito electrónico, el <a href=\"/le-neotone\">Neotone</a> está disponible con 10 notas y el Mutant con 19."
          }
        ]
      },
      {
      ...
      },
      {
        "id": "acoustique-electronique",
        "icon": "lucide:git-compare",
        "heading": "¿Acústica o electrónica?",
        "blocks": [
          {
            "kind": "p",
      ...
      },
      {
        "id": "essayer",
        "icon": "lucide:map-pin",
        "heading": "Dónde probarlo antes de comprarlo",
        "blocks": [
          {
            "kind": "p",
      ...
      },
      {
        ...
        "heading": "Errores que se deben evitar",
        "blocks": [
          {
            "kind": "ul",
            "items": [
    ...
    "related": [
      {
        "href": "/le-neotone",
        "label": "El handpan electrónico Neotone (10 y 19 notas)"
      },
      {
        "href": "/showroom",
        "label": "Probando un handpan en la sala de exposiciones de París."
      },
      {
        "href": "/boutique",
        "label": "Accesorios: fundas, soportes…"
      },
      {
        "href": "/handpan-electronique-vs-acoustique",
        "label": "Comparación entre sistemas electrónicos y acústicos."
      }
    ],
    "faqHeading": "Preguntas frecuentes",
    "faq": [
