...
export const products: Product[] = [
  // Application Handpan Constellation Studio — produit phare digital
  { id: 'handpan-studio', price: 0, image: '/images/app-logique.webp', imgW: 1100, imgH: 1327, url: '/handpan-app', category: 'app', active: true, mode: 'link', linkLabel: 'discover', tagKey: 'app', priceLabel: 'Version gratuite ou Studio dès 9,90 €/mois', images: ['/images/app-logique.webp', '/images/app-atlas.webp', '/images/app-creation.webp', '/images/app-midi-mapping-2026.webp', '/images/constel-polygone.webp'] },
