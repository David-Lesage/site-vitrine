...
const fr: GuidesByLang = {
  ...
  learn: {
    ...
    related: [
      { href: '/handpan-app', label: 'Découvrir l’app Handpan Compagnon' },
  ...
  vsAcoustic: {
    ...
    related: [
      ...
      { href: '/handpan-app', label: 'L’app Handpan Compagnon (acoustique + électronique)' },
