...
const fr: GuidesByLang = {
  ...
  learn: {
    ...
    cta: {
      ...
      primary: { href: 'https://play.handpanstudio.app', label: 'Ouvrir Handpan Studio', external: true },
  ...
  vsAcoustic: {
    ...
    cta: {
      ...
      secondary: { href: 'https://play.handpanstudio.app', label: 'Ouvrir Handpan Studio', external: true },
    },
    datePublished: '2026-07-01',
    dateModified: '2026-07-01',
  },
...
const en: GuidesByLang = {
  learn: {
    ...
    cta: {
      ...
      primary: { href: 'https://play.handpanstudio.app', label: 'Open Handpan Studio', external: true },
  ...
  vsAcoustic: {
    ...
    cta: {
      ...
      secondary: { href: 'https://play.handpanstudio.app', label: 'Open Handpan Studio', external: true },
    },
    datePublished: '2026-07-01',
    dateModified: '2026-07-01',
  },
