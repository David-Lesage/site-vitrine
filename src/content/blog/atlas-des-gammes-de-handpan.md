...
Une liste de gammes, c'est un mur de noms : D Kurd, Céltique, Hijaz, Amara… Pour un débutant, ça ne veut rien dire. L'Atlas renverse le problème : au lieu de lire des noms, tu **écoutes** et tu **vois**. Une gamme n'est plus une étiquette, c'est une couleur d'émotion que ton oreille reconnaît immédiatement.

C'est aussi une façon de comprendre d'où vient le handpan. Beaucoup de ses gammes s'inspirent de traditions musicales du monde — modes méditerranéens, ambiances orientales, couleurs celtiques. L'Atlas rend ce voyage tangible : tu passes d'une culture à l'autre en quelques secondes.

## Ce que tu peux faire dans l'Atlas

### Parcourir par ambiance
...
Chaque gamme s'affiche sur un pan avec les **ChromaKeys** : chaque note, sa couleur. Tu vois immédiatement la disposition, le nombre de notes, la place du ding central. Cette lecture visuelle est la même partout dans l'app — c'est la méthode expliquée dans [Le handpan par les couleurs](/blog/handpan-par-les-couleurs).
