---
title: "De 2 à 24 tonalités : compléter son handpan acoustique avec un Neotone"
description: "Tu as un D Kurd 10 et tu tournes en rond. Posé à côté, un Neotone y ajoute exactement les notes qui manquent : 2 tonalités complètes deviennent 24, et tu peux enfin t'accompagner en chantant."
pubDate: 2026-08-31
...
![Le cycle des quintes : avec un D Kurd 10 seul, 2 tonalités complètes sur 24 ; avec le Neotone, les 24](/images/blog-hybride-24-tonalites.svg)
...
![Trois bandes de registre : ce qu'il reste au-dessus de l'accord pour jouer la mélodie, avec le D Kurd 10 seul, avec le Neotone¹, avec le Mutant](/images/blog-hybride-registre-chanteur.svg)
...
C'est un **second instrument**, donc un achat. Sur la [boutique](/boutique), le Neotone¹ est affiché dès **1 990 €** et le Mutant dès **3 150 €** ; le détail des éditions et le calculateur sont sur la [page du Neotone](/le-neotone). Ce n'est pas un accessoire. C'est une décision.
...
<!-- 📷 PHOTO MANQUANTE — l'acoustique + le Neotone en vrai, à faire par David.
     ...
     ⛔ AUCUNE image n'a été fabriquée pour la remplacer. Les quatre schémas de l'article sont
        des SVG dessinés à partir des sorties réelles du moteur, et ils sont annoncés comme
        des schémas — jamais comme des photos. La photo de couverture
        (`/images/showroom-instruments.webp`) est une vraie photo du showroom, réutilisée
        telle quelle : on y voit bien deux Neotone et deux handpans acoustiques dans la même
        pièce, mais pas le duo en position de jeu.
     QUAND ELLE ARRIVE :
     ...
     L'article se lit entièrement sans elle : aucune phrase ne pointe vers une image absente. -->
