...
Une gamme de handpan est un choix, donc une renonciation. Tu as neuf ou dix notes, magnifiques, et il manquera toujours **celle** qui rendrait jouable l'accord dont tu rêves. C'est la frustration la plus fréquente, et la plus mal expliquée : on croit qu'on ne sait pas faire, alors que la note n'existe simplement pas sous nos mains.

Le funnel « **Compléter ta gamme** » répond à ça franchement. Il compare les notes réelles de ton instrument — octaves comprises — avec ce que demandent les accords, et te montre, **accord par accord**, quelles notes manquent.

## Ce qu'un second pan débloque, en clair

Le vrai progrès n'est pas la liste des notes manquantes : c'est la traduction en musique. Chaque proposition t'annonce désormais **combien de morceaux elle rend jouables**, et lesquels. Hallelujah, Let It Be, No Woman No Cry… plutôt que des degrés abstraits.

L'app te signale aussi ce que tu as déjà sans le savoir : la **gamme relative**, souvent jouable telle quelle sur ton pan, qu'il aurait été dommage d'ignorer avant de faire fabriquer quoi que ce soit.
...
Deux détails valent de l'or avant de commander quoi que ce soit :
