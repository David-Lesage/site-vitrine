...
export const es: Dict = {
  ...
  "atlas": {
    ...
    "heroLead": "Atlas fabrica trípodes para handpan en Italia. El instrumento no se atornilla ni se sujeta con correas: descansa sobre un disco flotante sostenido por imanes. Me acabo de convertir en socio de la marca y dos modelos llegarán pronto a la sala de exposición: el Atlas Pro y el Atlas All.",
    ...
    "heroTryNote": "Ambos modelos estarán en la sala de exposición, en el distrito 20 de París, junto con los handpans. Colocas un instrumento, ajustas la altura, tocas y listo.",
    ...
    "storyConclusion": "Considerando todo lo que he probado, este es el primer concepto que resuelve todos los problemas que he encontrado: un soporte magnético en lugar de una ventosa, un Atlas Pro fabricado completamente en aluminio —incluidas las patas telescópicas— y que pesa solo 1,8 kg con su estuche. Me ha convencido y espero con impaciencia su llegada.",
    "storyBridge": "Y hay una ironía que me gusta: ese mismo pie permite adoptar la postura opuesta a la mía. Su cabezal te permite tocar sentado, sin apoyar el instrumento en las piernas, algo que nunca he hecho y que estoy a punto de descubrir.",
