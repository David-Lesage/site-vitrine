...
const fr = {
  ...
  shop: {
    ...
    linkTags: { helloasso: 'Sur HelloAsso', streaming: 'En streaming', hisong: '−5 % Hisong', yishama: 'Ambassadeur Yishama', nowgroove: 'Now Groove', ondemand: 'Sur demande' },
    ...
    categories: {
      ...
      instruments: { label: 'Instruments d’exception', blurb: 'Les instruments acoustiques que je joue, crée et recommande — choisis avec exigence.' },
    ...
    products: {
      ...
      'yishama': { name: 'Handpan Yishama d’exception', description: 'Le handpan acoustique haut de gamme que je recommande en tant qu’ambassadeur Yishama — facture artisanale, justesse et timbre remarquables.' },
      'calebasse': { name: 'Calebasse signature David Lesage', description: 'Instrument de percussion en calebasse, monté et signé Now Groove. Idéal pour le rythme, la pratique et la scène. Sur commande.' },
      'gonilele': { name: 'Harpe africaine Gonilele', description: 'Harpe-luth artisanale aux sonorités envoûtantes, façonnée à la main. Pièce rare, disponible sur demande.' },
