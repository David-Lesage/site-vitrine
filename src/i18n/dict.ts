...
const fr = {
  ...
  shop: {
    ...
    products: {
      'handpan-studio': { name: 'Handpan Studio · l’application', description: 'Mon application pédagogique : couleurs, géométrie et émotions rendent la musique visible. Découverte gratuite, puis contribution libre — un outil vivant, en évolution permanente, façonné par sa communauté.' },
      ...
      'micro-hisong': { name: 'Micro Hisong AirStudio S1', description: 'Le premier studio mobile tout-en-un (micro, retours intra sans fil, interface audio, boîtier de charge). Idéal pour la voix, le handpan acoustique et le gonilélé — un véritable studio portatif. Démonstrations et achat en direct à mes showcases à Paris. −5 % avec mon code.' },
      'micro-muling': { name: 'Micro Muling MP1 + préampli HMP-2', description: 'Le MP1 est un micro contact-condensateur conçu pour le handpan acoustique. Fourni avec le préampli HMP-2, qui accueille jusqu’à deux micros MP1 — pour une captation stéréo, claire et précise, sans Larsen. Idéal pour la scène et l’enregistrement.' },
