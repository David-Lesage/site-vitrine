...
const fr = {
  ...
  shop: {
    ...
    products: {
      ...
      'housse': { name: 'Housse de calebasse haut de gamme', description: 'Housse de transport pensée et designée par David Lesage pour protéger ta calebasse signature partout. Finitions soignées. Disponible en pré-vente.' },
