...
const fr = {
  ...
  shop: {
    ...
    priceNotes: {
      hisong:
        '<strong>Attention :</strong> les prix affichés chez Hisong sont <strong>hors taxes</strong>. La <strong>TVA</strong> (20 % en France) et les <strong>frais de port</strong> — variables selon le transporteur que tu choisis — s’ajoutent au moment du paiement.<br><br><strong>Bonne nouvelle, les remises se cumulent :</strong> mon code <strong>−5 %</strong> + le code <strong>VIP10</strong> (−10 % sur la 1ʳᵉ commande, appliqué automatiquement), et parfois des promotions exceptionnelles de 15 à 20 %.<br><br><strong>Exemple concret :</strong> le kit Musicien à 265,95 € HT revient à environ <strong>227 € HT</strong> après les deux remises, soit environ <strong>273 € TTC</strong>. Le kit Master (354,95 € HT) revient à environ <strong>364 € TTC</strong>. Frais de port en supplément.',
    },
    ...
    products: {
      ...
      'micro-hisong': { name: 'Micro Hisong AirStudio S1', description: 'Le premier studio mobile tout-en-un (micro, retours intra sans fil, interface audio, boîtier de charge). Idéal pour la voix, le handpan acoustique et le gonilélé — un véritable studio portatif. Trois kits au choix : Musicien 4-en-1 (265,95 €), Créateur 5-en-1 (309,95 €) et Master 6-en-1 (354,95 €). Démonstrations et achat en direct à mes showcases à Paris. −5 % avec mon code.' },
