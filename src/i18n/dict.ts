...
const fr = {
  ...
  studio: {
    ...
    versionAcoTitle: 'Pour ton handpan acoustique',
    versionAcoText: 'Tu joues déjà d’un handpan acoustique ? Handpan Studio est aussi fait pour toi. Active le mode acoustique et retrouve toute l’approche visuelle — couleurs, constellations et émotions — directement sur ton instrument : visualise ta gamme, apprends de nouveaux accords, et imagine la gamme sur mesure dont tu rêves.',
