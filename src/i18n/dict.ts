...
const fr = {
  ...
  showroom: {
    ...
    program: [
      ...
      { t: 'Le son acoustique & les micros', d: 'Mes handpans Yishama, dont je suis ambassadeur, sonorisés par les micros Hisong et Muling — pour comparer et entendre la différence.' },
