...
const fr = {
  ...
  booking: {
    ...
    privateIntro: 'Cours ou démonstration privée, en présentiel à Paris ou en visio. Sur mesure, je t’accompagne.',
    ...
    sessionTypeNames: { demo: 'Démonstration privée', lesson: 'Cours présentiel' },
