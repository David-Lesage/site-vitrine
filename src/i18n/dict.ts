...
const fr = {
  ...
  shop: {
    ...
    linkTags: { helloasso: 'Sur HelloAsso', streaming: 'En streaming', hisong: '−5 % Hisong', yishama: 'Ambassadeur Yishama', nowgroove: 'Now Groove', ondemand: 'Sur demande', maisongoni: 'La Maison du Ngoni', tambour: 'Code David-Tambour' },
    ...
    products: {
      ...
      'gonilele': { name: 'Harpe Gonilélé · La Maison du Ngoni', description: 'Harpe-luth de voyage créée par Joris Feuillâtre (La Maison du Ngoni) — l’alliance du masculin et du féminin. 10 cordes (440 €) ou 12 cordes avec micro intégré (520 €). Commande via moi.' },
      'calebasse': { name: 'Calebasse signature David Lesage', description: 'Calebasse de 46 cm et plus (rare en Europe), finie à la main par Kamou (Djoliba Percussion) et gravée au laser du logo Now Groove. Une batterie organique au son naturel.' },
