...
const fr = {
  ...
  neotone: {
    ...
    woodsIntro: 'Le frêne naturel est inclus dans le prix de base. Quatre autres essences nobles sont disponibles en option.',
  ...
  studio: {
    ...
    waitTitle: 'Je veux être informé dès la sortie de l’app',
    waitText: 'L’application sera bientôt disponible. Laisse ton e-mail : tu seras prévenu·e en avant-première, sans spam.',
    waitButton: 'Rejoindre',
  },
  showroom: {
    ...
    agendaIntro: 'Les prochaines dates arrivent. Inscris-toi à la communauté pour être prévenu·e en priorité.',
