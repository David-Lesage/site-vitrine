...
const fr = {
  ...
  muling: {
    ...
    specsCaution: 'Bon à savoir : le câble de la capsule est solidaire (non détachable). En cas de dommage, il faut passer par un technicien ou remplacer l’ensemble — un point à garder en tête pour le transport.',
