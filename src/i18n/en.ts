...
export const en: Dict = {
  ...
  shop: {
    ...
    linkTags: { helloasso: 'On HelloAsso', streaming: 'Streaming', hisong: '−5% Hisong', yishama: 'Yishama ambassador', nowgroove: 'Now Groove', ondemand: 'On request', maisongoni: 'La Maison du Ngoni', tambour: 'Code David-Tambour', spotify: 'On Spotify', limited: 'Limited edition', app: 'App' },
    ...
    products: {
      'handpan-studio': { name: 'Handpan Studio · the app', description: 'My teaching app: colours, geometry and emotions make music visible. Free to start, then pay-what-you-want — a living tool, constantly evolving, shaped by its community.' },
