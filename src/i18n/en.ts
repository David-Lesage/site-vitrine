...
export const en: Dict = {
  ...
  muling: {
    ...
    specsCaution: 'Worth knowing: the capsule’s cable is permanently attached (not detachable). If damaged, you’ll need a technician or a full replacement — something to keep in mind when travelling.',
