...
export const en: Dict = {
  ...
  shop: {
    ...
    linkTags: { helloasso: 'On HelloAsso', streaming: 'Streaming', hisong: '−5% Hisong', yishama: 'Yishama ambassador', nowgroove: 'Now Groove', ondemand: 'On request', maisongoni: 'La Maison du Ngoni', tambour: 'Code David-Tambour' },
    ...
    products: {
      ...
      'gonilele': { name: 'Gonilélé harp · La Maison du Ngoni', description: 'A travel harp-lute created by Joris Feuillâtre (La Maison du Ngoni) — the union of masculine and feminine. 10 strings (€440) or 12 strings with built-in pickup (€520). Order through me.' },
      'calebasse': { name: 'David Lesage signature calabash', description: 'A calabash 46 cm and over (rare in Europe), hand-finished by Kamou (Djoliba Percussion) and laser-engraved with the Now Groove logo. An organic drum with a natural sound.' },
