...
export const en: Dict = {
  ...
  shop: {
    ...
    products: {
      ...
      'housse': { name: 'Premium calabash cover', description: 'A travel cover designed by David Lesage to protect your signature calabash anywhere. Refined finish. Available on pre-sale.' },
