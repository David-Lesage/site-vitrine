...
export const en: Dict = {
  ...
  shop: {
    ...
    eyebrow: 'Shop',
    title2: 'A selection tested and chosen by me',
    intro: 'Exceptional instruments and accessories. The Neotone, given its specific purchase process, is ordered via a discount-code request; accessories are direct purchase.',
    ...
    linkTags: { helloasso: 'On HelloAsso', streaming: 'Streaming', hisong: '−5% Hisong', yishama: 'Yishama ambassador', nowgroove: 'Now Groove', ondemand: 'On request' },
    ...
    categories: {
      ...
      instruments: { label: 'Exceptional instruments', blurb: 'The acoustic instruments I play, craft and recommend — chosen with care.' },
      micros: { label: 'Microphones', blurb: 'Pickup for acoustic handpan, voice and gong.' },
      musique: { label: 'Music & courses', blurb: 'My albums, my rhythm method and my lessons — available on my partner platforms.' },
    },
    products: {
      ...
      'yishama': { name: 'Yishama exceptional handpan', description: 'The high-end acoustic handpan I recommend as a Yishama ambassador — artisan craftsmanship, remarkable tuning and timbre.' },
      'calebasse': { name: 'David Lesage signature calabash', description: 'A calabash percussion instrument, built and signed Now Groove. Ideal for rhythm, practice and stage. Made to order.' },
      'gonilele': { name: 'Gonilele African harp', description: 'A handcrafted harp-lute with bewitching tones, shaped by hand. A rare piece, available on request.' },
      'micro-hisong': { name: 'Hisong AirStudio S1 microphone', description: 'The first all-in-one mobile studio: studio mic, wireless in-ear monitors, audio interface and charging case. Perfect to record handpan, voice and instruments. −5% with my code.' },
      'micro-muling': { name: 'Muling microphone', description: 'Coming soon.' },
      'album-phoenix': { name: 'Album “The Phoenix Alliance”', description: 'My original album — a musical journey blending handpan, voice and organic textures. Available on CD and download.' },
  ...
  lessons: {
    title: 'Handpan lessons — online & in person in Paris | David Lesage',
    description:
      'Learn the handpan differently: through colours, shapes and emotions. Private lessons online worldwide or in person in Paris, plus group workshops.',
    heroEyebrow: 'The lessons',
    heroTitle: 'Learn the handpan differently',
    heroLead: 'Through colours, shapes and emotions. Online anywhere in the world, or in person in Paris. A visual method, designed by a musician who plays every day.',
    ...
    formulas: [
      { title: 'Private lesson · 1h', price: '€50', text: 'Online or in person in Paris. Create your custom scales, master the Neotone interface, play pieces and techniques.' },
      { title: 'Private lesson · 1h30', price: '€70', text: 'The ideal format to go further: harmony, accompaniment, stage and studio tips.' },
      { title: 'Group workshop', price: 'On request', text: 'Group sessions in a small setting, in a friendly atmosphere. Format and venue on request.' },
    ],
  ...
  studio: {
    ...
    modes: [
      ...
      { t: 'MIDI Connect', d: 'The bridge between your Neotone and the app: your real playing appears live on the virtual handpan, and the app validates your exercises.' },
    ],
    versionAcoTitle: 'Acoustic handpan version',
    versionAcoText: 'Handpan Studio also works with your acoustic handpan. Missing notes to go further? That’s exactly where the Neotone opens up the infinite field of scales.',
    versionAcoCta: 'Discover the Neotone',
    ...
    waitText: 'Create your account and launch Handpan Studio right in your browser. Choosing your plan and secure payment happen inside the app.',
    waitButton: 'Open the app',
    contribEyebrow: 'A contributive community',
    contribTitle: 'You’re not downloading an app — you’re joining a living project',
    contribIntro:
      'Handpan Studio evolves constantly, shaped by the people who use it. By subscribing you don’t become a mere customer: you become a contributor to a unique teaching tool — and your voice directly shapes what comes next.',
    contribCards: [
    ...
    priceEyebrow: 'Pricing · contribution',
    priceTitle: 'Choose your contribution',
    priceIntro:
      'You don’t pay for a finished product: you fund the evolution of a living tool and become part of what it becomes. Start for free, contribute whenever you like — and unlock the whole studio.',
    priceCta: 'I contribute',
    priceFreeCta: 'Start for free',
    pricePopular: 'Most chosen',
    priceMax: 'Maximum support',
    priceOnce: 'one-time',
    pricePerMonth: '/ month',
    pricePerYear: '/ year',
    priceFree: {
      name: 'Discovery',
      price: 'Free',
      blurb: 'Create your account and explore Handpan Studio with a limited free access — enough to taste the visual method.',
    },
    priceTiers: {
      monthly: { name: 'Monthly contribution', blurb: 'You support development month by month, no commitment. Stop whenever you want.' },
      annual: { name: 'Annual contribution', blurb: 'A year of support, two months free. You fund the next features.' },
      lifetime: { name: 'Lifetime contribution', blurb: 'You believe in the project long-term: one gesture, lifetime access.' },
    },
    priceNote: 'Amounts synced live with Stripe. Full studio access opens from your first contribution, no commitment.',
