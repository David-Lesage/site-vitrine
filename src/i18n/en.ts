...
export const en: Dict = {
  common: {
    ...
    beta: {
      ...
      formUsage: 'What will you use Handpan Studio for?',
  ...
  booking: {
    ...
    successClose: 'Close',
    close: 'Close',
    visitTitle: 'Book my showroom visit',
    visitIntro: 'Paris 20th, by appointment. Tell me when you’re available and I’ll suggest a slot.',
    privateTitle: 'Book an individual appointment',
    privateIntro: 'A private demo to discover the instruments at the showroom, or a lesson — in person in Paris or online. Tailor-made, I guide you through it.',
    sessionType: 'Which appointment would you like?',
    sessionTypeChoose: 'Choose…',
    sessionTypeNames: { onboarding: 'Neotone getting-started session', demo: 'Private demo', lesson: 'Music lesson' },
    ...
    sessionTypeHint: 'Just received your Neotone and feeling a bit lost? That’s exactly what the getting-started session is for: we set the instrument up together and walk through the interface — without committing to music lessons.',
    ...
    terms3: 'Something came up? The appointment can be rescheduled up to 24 h beforehand. After that, the payment is non-refundable: I’ve already set that slot aside for you in my diary.',
  ...
  muling: {
    ...
    orderText:
      'The maker doesn’t offer online payment for France yet: I put you in touch directly. Fill in the form, I confirm your request and send you Muling’s payment details — I stay by your side until your mic arrives.',
    ctaContact: 'Order my mic',
    mulingOrderTitle: 'Order the Muling mic',
    mulingOrderIntro: 'Code {code} applied — {pct}% off the maker’s price. I’ll pass your request on to Muling and get back to you with payment details.',
    ...
    mulingBankNext: 'Once you’ve paid, keep proof of payment — I’ll get back to you to confirm it with Muling.',
    ...
    mulingThankYouText: 'Your details have been sent to Muling. They’ll get in touch with you for the next steps — shipping and order tracking.',
  ...
  studio: {
    ...
    faqEyebrow: 'FAQ',
    faqTitle: 'The questions people ask me about Handpan Studio',
    faq: [
      { q: 'Do I need a Neotone to use Handpan Studio?', a: 'No. Handpan Studio works on any acoustic handpan, in the free acoustic mode, just as it does on the electronic Neotone handpan. You do not need the electronic instrument to get started.' },
      { q: 'Does Handpan Studio work on an acoustic handpan?', a: 'Yes, the acoustic mode is free. You visualise your scale in colours and learn your chords directly on your own acoustic instrument.' },
  ...
  showroom: {
    ...
    events: [
      ...
      { t: 'Neotone getting-started session', d: 'Just received your instrument? We set it up together and walk through the interface, step by step. In person or online.', price: '' },
      { t: 'Private demonstration', d: 'A private session at the showroom to explore the Neotone, the calabash, the Gonilélé or the microphones in depth.', price: '1h30 · €50' },
      { t: 'Music lesson', d: 'With David Lesage: create your scales, play pieces and techniques. In person or online.', price: '1h · €50 · 1h30 · €70' },
    ],
  ...
  data: {
    ...
    procedureShowroom: [
      { title: 'Book a session with me', text: 'Two options: come to one of my public showcase dates (one a month), or book a private one-hour appointment just for you (€50).' },
