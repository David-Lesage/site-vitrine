...
export const en: Dict = {
  ...
  neotone: {
    ...
    woodsIntro: 'Natural ash is included in the base price. Four other noble woods are available as an option.',
  ...
  studio: {
    ...
    waitTitle: 'I want to be notified as soon as the app is released',
    waitText: 'The app will be available soon. Leave your email: you’ll be notified first, with no spam.',
    waitButton: 'Join',
  },
  showroom: {
    ...
    agendaIntro: 'Upcoming dates are coming. Join the community to be notified first.',
