...
export const en: Dict = {
  ...
  shop: {
    ...
    linkExternal: 'On HelloAsso',
    linkStreaming: 'Streaming',
    buyCta: 'See offer →',
    listenCta: 'Listen →',
    ...
    products: {
      ...
      'micro-hisong': { name: 'Hisong microphone', description: 'Pickup microphone for acoustic handpan, voice and gong. Chosen and tested by David — already adopted by the community.' },
