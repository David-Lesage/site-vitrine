...
export const en: Dict = {
  ...
  showroom: {
    ...
    program: [
      ...
      { t: 'Acoustic sound & microphones', d: 'My Yishama handpans, for which I am an ambassador, miked with the Hisong and Muling microphones — to compare and hear the difference.' },
