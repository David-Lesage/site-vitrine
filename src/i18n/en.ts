...
export const en: Dict = {
  ...
  studio: {
    ...
    versionAcoTitle: 'For your acoustic handpan',
    versionAcoText: 'Already play an acoustic handpan? Handpan Studio is for you too. Switch on acoustic mode and get the whole visual approach — colours, constellations and emotions — right on your instrument: see your scale, learn new chords, and imagine the custom scale you dream of.',
