...
export const en: Dict = {
  ...
  shop: {
    ...
    products: {
      ...
      'housse': { name: 'Now Groove calabash cover', description: 'A premium backpack cover designed by David Lesage: integrated mat function, detachable straps, storage pocket (eggs, accessories & method), velvet lining. ✋ Special handmade edition, ultra-limited series.' },
